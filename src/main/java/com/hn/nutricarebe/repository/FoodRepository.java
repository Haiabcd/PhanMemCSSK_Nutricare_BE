...
public interface FoodRepository extends JpaRepository<Food, UUID> {
    ...
    // Lấy món ăn theo ID
    @EntityGraph(attributePaths = {"mealSlots", "tags", "ingredients", "ingredients.ingredient"})
    ...
    @Query("select f.createdAt from Food f " + "where f.createdAt >= :start and f.createdAt < :end")
