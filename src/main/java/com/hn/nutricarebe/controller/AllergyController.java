...
public class AllergyController {
    ...
    public ApiResponse<Void> saveAllergy(@Valid @RequestBody AllergyRequest request) {
        ...
        return ApiResponse.<Void>builder().message("Tạo dị ứng thành công").build();
    }
    ...
    public ApiResponse<Void> deleteAllergy(@PathVariable UUID id) {
        ...
        return ApiResponse.<Void>builder().message("Xoá dị ứng thành công").build();
    }

    // Cập nhật dị ứng
    @PutMapping("/{id}")
    public ApiResponse<Void> update(@PathVariable UUID id, @Valid @RequestBody AllergyRequest request) {
        allergyService.update(id, request);
        return ApiResponse.<Void>builder().message("Cập nhật dị ứng thành công").build();
    }
}
